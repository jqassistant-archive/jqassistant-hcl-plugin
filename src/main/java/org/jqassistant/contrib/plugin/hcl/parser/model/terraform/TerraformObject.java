...
public abstract class TerraformObject<T extends TerraformBlock> {
   ...
   */
  protected abstract T saveInternalState(T object, final TerraformLogicalModule partOfModule, StoreHelper storeHelper);
   ...
   */
  public T toStore(final StoreHelper storeHelper, final String fullQualifiedName,
    ...
    return saveInternalState(object, partOfModule, storeHelper);
  }
}
